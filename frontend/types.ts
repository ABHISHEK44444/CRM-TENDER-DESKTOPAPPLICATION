...
export enum TenderDocumentType {
    ...
    PreDeliveryInspectionCertificate = 'Pre-Delivery Inspection Certificate',
    Invoice = 'Invoice',
...
export interface NewTenderData {
  ...
  description: string;
  source?: string;
  // FIX: Add optional 'assignedTo' property to align with backend expectations and fix type error.
  assignedTo?: string[];
}
...
export interface NewUserData {
    ...
    department?: string;
    designation?: string;
    specializations?: string; // Comma-separated string for input
    password?: string;
