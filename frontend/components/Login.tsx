...
interface LoginProps {
    // FIX: Update onLogin to return a Promise<boolean> to support async operations.
...
const Login: React.FC<LoginProps> = ({ onLogin }) => {
    ...
    // FIX: Make handleSubmit async and await the result of onLogin.
        ...
        >
            <div className="w-full max-w-md bg-white/80 dark:bg-[#0d1117]/80 backdrop-blur-xl rounded-2xl shadow-2xl p-8 border border-white/20 dark:border-slate-700/50">
                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-6">
                  ...
                  <div className="mt-6 text-center text-xs text-gray-800 dark:text-gray-700">
